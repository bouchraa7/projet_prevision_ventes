"""
LIGHTGBM - RandomizedSearchCV (8 features)
...
print("="*60)
print("⚡ LIGHTGBM - RandomizedSearchCV (8 features)")
print("="*60)
...
lgb_base = lgb.LGBMRegressor(**fixed_params)
...
for f, v in sorted(importance.items(), key=lambda x: x[1], reverse=True):
    ...
    pct = v / total * 100
    print(f"   {f:<22}: {v} {bar} ({pct:.1f}%)")

# ============================================================================
# SAUVEGARDE
# ============================================================================
with open('results/lightgbm_8f_auto.pkl', 'wb') as f:
    pickle.dump({
        'model': model,
        'scaler': scaler,
        'features': features,
...
print("\n💾 Modèle sauvegardé: results/lightgbm_8f_auto.pkl")
print("\n✅ LightGBM terminé !")
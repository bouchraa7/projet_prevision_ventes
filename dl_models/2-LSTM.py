"""
LSTM - RandomizedSearchCV (Version DÉTERMINISTE)
...
print("="*70)
print("🧠 LSTM - RandomizedSearchCV (Version DÉTERMINISTE)")
print("="*70)
...
n_iter = 20  # Nombre de combinaisons aléatoires
print(f"\n📊 Nombre de combinaisons aléatoires: {n_iter}")

# Générer les combinaisons aléatoires (reproductibles)
random_params = list(ParameterSampler(param_dist, n_iter=n_iter, random_state=42))

# ============================================================================
# 7. TEST DES COMBINAISONS ALÉATOIRES
# ============================================================================
results = []
best_r2 = -np.inf
best_config = None
...
for params in random_params:
    ...
    # RAZ des graines avant chaque modèle
    random.seed(42)
    np.random.seed(42)
    tf.random.set_seed(42)
...
# ============================================================================
print("\n" + "="*70)
print("🏆 MEILLEURE CONFIGURATION LSTM (RandomizedSearch)")
print("="*70)
...
print("\n" + "="*70)
print("📊 RÉSULTATS FINAUX LSTM (RandomizedSearch)")
print("="*70)
...
# Sauvegarde
model.save('results/dl_results/lstm_randomized_final.h5')
results_df.to_csv('results/dl_results/lstm_randomized_results.csv', index=False)

with open('results/dl_results/lstm_randomized_best.json', 'w') as f:
    json.dump(best_config, f, indent=4)

print("\n💾 Fichiers sauvegardés dans results/dl_results/")
print("\n✅ LSTM RandomizedSearchCV terminé!")
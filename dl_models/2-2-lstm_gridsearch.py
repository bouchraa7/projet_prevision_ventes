"""
LSTM - GridSearchCV (Version COMPLÈTE et DÉTERMINISTE)
...
print("="*70)
print("🧠 LSTM - GridSearchCV (Version COMPLÈTE et DÉTERMINISTE)")
print("="*70)
...
# ============================================================================
print("\n" + "="*70)
print("🏆 MEILLEURE CONFIGURATION LSTM (GridSearch)")
print("="*70)
...
# ============================================================================
print("\n" + "="*70)
print("📊 TOP 10 CONFIGURATIONS LSTM")
print("="*70)
...
for i in range(best_config['layers']):
    ...
    if i == 0:
        model.add(LSTM(best_config['units'], return_sequences=return_seq, input_shape=(SEQ_LEN, 1)))
    else:
        model.add(LSTM(best_config['units'], return_sequences=return_seq))
...
print("\n" + "="*70)
print("📊 RÉSULTATS FINAUX LSTM (GridSearch)")
print("="*70)
...
axes[1].set_title(f'LSTM - Prédictions vs Réel (R²={r2_final:.4f})')
axes[1].legend()
axes[1].grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig('results/dl_results/lstm_gridsearch_final.png', dpi=150)
plt.show()

# ============================================================================
# 13. SAUVEGARDE
# ============================================================================
model.save('results/dl_results/lstm_gridsearch_final.h5')

# Sauvegarde des résultats
results_df.to_csv('results/dl_results/lstm_gridsearch_results.csv', index=False)

# Sauvegarde de la meilleure configuration
with open('results/dl_results/lstm_gridsearch_best.json', 'w') as f:
    json.dump(best_config, f, indent=4)

print("\n💾 Fichiers sauvegardés:")
print("   results/dl_results/lstm_gridsearch_final.h5")
print("   results/dl_results/lstm_gridsearch_results.csv")
print("   results/dl_results/lstm_gridsearch_best.json")

# ============================================================================
# 14. RÉSUMÉ FINAL
# ============================================================================
print("\n" + "="*70)
print("📝 RÉSUMÉ FINAL LSTM")
print("="*70)

print(f"""
   🧠 LSTM - GridSearchCV (Version complète)
...
print("✅ LSTM GridSearchCV terminé!")